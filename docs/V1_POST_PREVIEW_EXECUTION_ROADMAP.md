...
1. **W08 - SEO Publication Gate**, after approved data, collection/detail route inventory, content and UI decisions stabilize.
...
4. **W06 - Locale Readiness Gate**, after English V1 and SEO ownership are stable.
W01, W02, W03, W05, W11 and the Post-W02 approved-data/product-preview handoff are complete. **W09 is a parallel support lane, not a serial step:** it may run read-only throughout W10 and never substitutes for implementation evidence. W03 promotion remains gated by its retained exceptions; W04, W07 and W06 remain blocked by their explicit launch/dependency conditions.
