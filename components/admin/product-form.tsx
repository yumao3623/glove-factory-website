...
type Product = { id: string; slug: string; name: string; family: string; material: string | null; length_cm: number | null; finger_style: string | null; colors: string[]; description: string | null; image_urls: string[]; status: "draft" | "active" | "archived" };
const empty = { slug: "", name: "", family: "bridal-gloves", material: "", length_cm: null as number | null, finger_style: "", colors: [] as string[], description: "", image_urls: [] as string[] };
...
export function ProductForm() {
  ...
  function edit(product: Product) {
    setEditing(product);
    setForm({ slug: product.slug, name: product.name, family: product.family, material: product.material ?? "", length_cm: product.length_cm, finger_style: product.finger_style ?? "", colors: product.colors ?? [], description: product.description ?? "", image_urls: product.image_urls ?? [] });
