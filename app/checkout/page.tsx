...
export default function CheckoutPage() {
  return <main id="main-content" className="mx-auto min-h-[60vh] max-w-[900px] px-5 py-16 sm:px-8 lg:py-24">
    ...
    <p className="mt-6 max-w-xl text-sm leading-6 text-stone-600">PayPal checkout will be offered after a confirmed quote, merchant KYC/KYB and a verified settlement route. A saved enquiry list does not reserve stock or place an order.</p>
