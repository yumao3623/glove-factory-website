...
test("sitemap includes only implemented indexable owners", () => {
  ...
  for (const included of ["\"/\"", "\"/products/\"", "\"/bridal-gloves/\"", "\"/opera-gloves/\"", "\"/costume-gloves/\"", "\"/kids-dress-gloves/\"", "\"/wedding-veils/\"", "\"/arm-sleeves/\""]) assert.ok(sitemap.includes(included));
